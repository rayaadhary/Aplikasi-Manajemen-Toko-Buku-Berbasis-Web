...
if(isset($_GET["id_pembeli"])){
	...
	<form method="post" name="frm" action="pembeli-hapus.php">
		<input type="hidden" name="id_pembeli" value="<?php echo $datapembeli["id_pembeli"];?>">
				<a href="pembeli.php"><button type="button" class="btn btn-outline-dark rounded">Tampil Pembeli</button></a>
<table class="table mt-1">
  ...
  <tbody>
    <tr>
      <td><?php echo $datapembeli["id_pembeli"];?></td>
      <td><?php echo $datapembeli["nama_pembeli"];?></td>
      <td><?php echo $datapembeli["telepon"];?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		echo "Pembeli dengan Id : $id_pembeli tidak ada. Penghapusan dibatalkan";
?>
<?php
}
else
	echo "ID Pembeli tidak ada. Penghapusan dibatalkan.";
?>
</body>
</html>