...
<!DOCTYPE html>
<html><head><title>Pembaruan Data Pembeli</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
...
if(isset($_POST["TblUpdate"])){
	...
	if($db->connect_errno==0){
        ...
        // validasi alamat
        if(strlen($alamat)==0)
        $pesansalah.="Alamat Pembeli tidak sah. Alamat Pembeli tidak boleh kosong.<br>";
		...
		$sql="UPDATE pembeli SET 
			  nama_pembeli='$nama_pembeli',telepon='$telepon', alamat='$alamat',
