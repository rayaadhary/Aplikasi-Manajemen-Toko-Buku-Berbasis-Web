...
if(isset($_GET["id_pegawai"])){
	...
	if($datapegawai=getDataPegawai($id_pegawai)){// cari data barang, kalau ada simpan di $data
		?>
<form method="post" name="frm" action="pegawai-ubah.php"  class="was-validated">
<div class="row mb-3">
   <label for="idpegawai" class="col-sm-2 col-form-label">ID Pegawai</label>
    <div class="col-sm-10">
      <input type="text" name="id_pegawai" value="<?php echo $datapegawai["id_pegawai"];?>" readonly
	  class="form-control" maxlength="5" id="idpegawai">
    </div>
  </div>
  <div class="row mb-3">
    <label for="namapegawai" class="col-sm-2 col-form-label">Nama Pegawai</label>
    <div class="col-sm-10">
      <input type="text" name="nama_pegawai" class="form-control" id="namapegawai" maxlength="30"
	  value="<?php echo $datapegawai["nama_pegawai"];?>" required>
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
	  ...
	  value="<?php echo $datapegawai["telepon"];?>" required>
	  <div class="invalid-feedback">
  ...
  <div class="row mb-3">
    ...
    <div class="col-sm-10">
	  ...
	  value="<?php echo $datapegawai["alamat"];?>" required>
	  <div class="invalid-feedback">
  ...
  <div class="d-flex justify-content-center">
	...
	<div class="modal-footer">
		...
		echo "Pegawai dengan Id : $id_pegawai tidak ada. Pengeditan dibatalkan";
?>
<?php
}
else
	echo "Id Pegawai tidak ada. Pengeditan dibatalkan.";
?>
</div>
</div>
</form>
